...
async function main() {
  ...
  for (const coach of coaches) {
    try {
      ...
      if (existingCoach) {
        console.log(
          `⏭️  Coach already exists: ${coach.first_name} ${coach.last_name}`,
        );
      ...
      console.log(
        `⚠️  Could not create coach ${coach.first_name} ${coach.last_name}:`,
        error,
      );
    }
  }
  ...
  if (createdSchools.length < 5 || createdCoaches.length < 5) {
    console.log(
      "⚠️  Missing required schools or coaches, skipping tryout creation",
    );
  ...
  console.log(
    `✅ Proceeding with tryout creation: ${createdSchools.length} schools, ${createdCoaches.length} coaches`,
  );
  ...
  for (let i = 0; i < 7; i++) {
    ...
    const coach =
      createdCoaches.find((c) => c.school_id === school.id) ??
      getRandomElement(createdCoaches);
    ...
    tryouts.push({
      ...
      location:
        getRandomElement([...tryoutTypes]) === "ONLINE"
          ? "Online - Discord Server"
          : `${school.name} Gaming Center`,
  ...
  for (let i = 0; i < 6; i++) {
    ...
    tryouts.push({
      ...
      location:
        getRandomElement([...tryoutTypes]) === "ONLINE"
          ? "Online - Custom Servers"
          : `${school.name} Esports Lab`,
      type: getRandomElement([...tryoutTypes]),
      status: "PUBLISHED" as const,
      price: getRandomElement(prices),
  ...
  for (let i = 0; i < 6; i++) {
    ...
    tryouts.push({
      ...
      location:
        getRandomElement([...tryoutTypes]) === "ONLINE"
          ? "Online - Parsec/Slippi"
          : `${school.name} Tournament Room`,
      type: getRandomElement([...tryoutTypes]),
      status: "PUBLISHED" as const,
      price: getRandomElement(prices),
  ...
  for (let i = 7; i <= 112; i += 7) {
    // Start 1 week out, every week for 16 weeks
  ...
  for (let i = 0; i < 3; i++) {
    ...
    combines.push({
      ...
      time_end: "17:00",
      location: isOnline
        ? "Online - Custom Servers & Discord"
        : `${school.name} Esports Arena`,
      ...
      status: getRandomElement(combineStatuses) as
        | "UPCOMING"
        | "REGISTRATION_OPEN"
        | "REGISTRATION_CLOSED",
  ...
  for (let i = 0; i < 4; i++) {
    ...
    combines.push({
      ...
      description:
        "Premier Overwatch 2 combine focusing on role mastery and team coordination.",
  ...
  for (let i = 0; i < 1; i++) {
    ...
    combines.push({
      ...
      description:
        "High-octane Rocket League combine testing mechanical skill and game sense.",
  ...
  for (let i = 0; i < 2; i++) {
    ...
    combines.push({
      ...
      description:
        "Elite Smash Ultimate combine for competitive fighting game players.",
  ...
  try {
    ...
    if (existingLeague) {
      ...
      const valorantGameId =
        valorantGame?.id ??
        createdGames.find((g) => g.short_name === "VAL")?.id;
      if (valorantGameId) {
  ...
  const gsePlayersData = [
    {
      ...
      firstName: "Cris",
      lastName: "C",
      team: "West Essex Regional High School",
      mainAgent: "Brimstone",
      role: "Controller",
      eval: 86.72903306,
    },
    {
      username: "Daydreaming",
      firstName: "Metehan",
      lastName: "K",
      team: "West Essex Regional High School",
      mainAgent: "Vyse",
    ...
    },
    {
      ...
      firstName: "Marcos",
      lastName: "C",
      team: "Haddon Heights High School",
      mainAgent: "Iso, Harbor",
    ...
    },
    {
      ...
      firstName: "Isaac",
      lastName: "Nunez",
      team: "Mercer County Tech",
      mainAgent: "Waylay, Killjoy",
    ...
    },
    {
      username: "Hermit",
      firstName: "Rafael",
      lastName: "Benedict Ramos",
      team: "Mercer County Tech",
      mainAgent: "Omen, KAY/O",
      role: "Controller, Initiator",
      eval: 82.81143954,
    },
    {
      username: "Beanman",
      firstName: "Pablo",
      lastName: "Cifuentes-Ochoa",
      team: "Mercer County Tech",
      mainAgent: "Breach, Iso",
    ...
    {
      username: "HeinousHyena493",
      firstName: "Jeremy",
      lastName: "Ellis",
      team: "Cherokee High School",
      mainAgent: "Cypher, Vyse",
      role: "Sentinel",
      eval: 83.98943963,
    },
    {
      ...
      firstName: "Juan",
      lastName: "Unknown",
      team: "East Side High School",
      mainAgent: "Waylay, Jett",
      role: "Duelist",
      eval: 78.51205351,
    },
    {
    ...
    {
      username: "ElColdestAlfredo",
      firstName: "Maria",
      lastName: "Unknown",
      team: "East Side High School",
      mainAgent: "Gekko, Tejo",
      role: "Initiator",
      eval: 69.07962584,
    },
    {
    ...
    },
    {
      ...
      firstName: "Sophia",
      lastName: "Yao",
      team: "East Brunswick High School",
      mainAgent: "Viper, Astra",
      role: "Controller",
      eval: 87.28541825,
    },
    {
    ...
    },
    {
      ...
      lastName: "Klinar",
      team: "East Brunswick High School",
      mainAgent: "Reyna, Jett",
      role: "Duelist",
      eval: 80.12229278,
    },
    {
      username: "spiderzayzooky",
      firstName: "David",
      lastName: "Z",
      team: "East Brunswick High School",
      mainAgent: "Killjoy, Cypher",
      role: "Sentinel",
      eval: 81.69212425,
    },
    {
    ...
    },
    {
      ...
      lastName: "Lin",
      team: "Cherry Hill High School East",
      mainAgent: "Cypher, Vyse, Skye, Breach",
      role: "Sentinel, Initiator",
      eval: 85.20318191,
    },
    {
    ...
    },
    {
      ...
      lastName: "Kim",
      team: "NVRHS Demarest",
      mainAgent: "Neon, Reyna, Gekko, Jett",
      role: "Duelist",
      eval: 77.92643957,
    },
    {
    ...
    },
    {
      username: "crepe",
      firstName: "Ezmeralda",
      lastName: "CruzVasquez",
      team: "Ocean Township High School",
      mainAgent: "Gekko, Breach",
      role: "Initiator",
      eval: 75.93239896,
    },
    {
    ...
    {
      username: "PiggyPlague303",
      firstName: "Henri",
      lastName: "Jean-Baptiste",
      team: "McNair Academic High School",
      mainAgent: "Vyse, Cypher",
      role: "Sentinel",
      eval: 91.81014646,
    },
    {
    ...
    {
      username: "GreenDragoon",
      firstName: "Nick",
      lastName: "S",
      team: "Barnegat High School",
      mainAgent: "Cypher, Killjoy",
      role: "Sentinel",
      eval: 81.14431801,
    },
    {
    ...
    },
    {
      ...
      firstName: "Wincent",
      lastName: "Qui",
      team: "Scotch Plains-Fanwood High School",
      mainAgent: "Omen",
      role: "Controller",
      eval: 90.63805246,
    },
    ...
    },
    {
      ...
      lastName: "Jones",
      team: "Scotch Plains-Fanwood High School",
      mainAgent: "Cypher, Chamber",
      role: "Sentinel",
      eval: 78.83894164,
    },
    {
      username: "BoopNoodleOnFire",
      firstName: "Matthew",
      lastName: "Mui",
      team: "Scotch Plains-Fanwood High School",
      mainAgent: "Tejo",
    ...
    },
    {
      ...
      firstName: "James",
      lastName: "L",
      team: "Holmdel High School",
      mainAgent: "Breach, Viper, Tejo",
      role: "Initiator",
      eval: 89.68333295,
    },
    {
  ...
  for (const gsePlayerData of gsePlayersData) {
    ...
    if (!school) {
      console.log(
        `⚠️  School not found for ${gsePlayerData.username}: ${gsePlayerData.team}`,
      );
      continue;
    }
    ...
    const player = {
      ...
      email: `${gsePlayerData.username.toLowerCase().replace(/[^a-z0-9]/g, "")}@${school.name
        .toLowerCase()
        .replace(/\s+/g, "")
      ...
      intended_major: getRandomElement([
        "Computer Science",
        "Information Technology",
        "Game Design",
        "Digital Media",
      ...
      scholastic_contact_email: `contact.${gsePlayerData.username.toLowerCase().replace(/[^a-z0-9]/g, "")}@${school.name
        .toLowerCase()
        .replace(/\s+/g, "")
        .replace(/[^a-z0-9]/g, "")}.edu`,
      extra_curriculars:
        "Garden State Esports League, Gaming Club, Academic Honor Society",
      academic_bio:
        "Competitive esports athlete with strong academic performance and leadership skills.",
    };
    ...
    try {
      ...
      if (existingPlayer) {
        ...
        console.log(
          `✅ Created GSE player: ${gsePlayerData.username} (${school.name})`,
        );
        createdGSEPlayers.push(newPlayer);

        // Create VALORANT game profile for GSE player
        if (valorantGame) {
          const agents = gsePlayerData.mainAgent
            .split(", ")
            .map((agent) => agent.trim());
          const roles = gsePlayerData.role
            .split(", ")
            .map((role) => role.trim());
          ...
          const gameProfile = {
            ...
            role: roles[0] ?? "Flex",
            agents: agents,
            preferred_maps: getRandomElements(
              [
                "Bind",
                "Haven",
                "Split",
          ...
          console.log(
            `✅ Created VALORANT profile for GSE player: ${gsePlayerData.username}`,
          );
          ...
          if (gseLeague) {
            ...
            console.log(
              `✅ Created league participation for GSE player: ${gsePlayerData.username}`,
            );
          }
        }
      }
      ...
      console.log(
        `⚠️  Could not create GSE player ${gsePlayerData.username}:`,
        error,
      );
    }
  }
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const classYear = getRandomElement([
      "Freshman",
      "Sophomore",
      "Junior",
      "Senior",
  ...
  for (const player of players) {
    try {
      ...
      if (existingPlayer) {
        console.log(
          `⏭️  Player already exists: ${player.first_name} ${player.last_name}`,
        );
        createdPlayers.push(existingPlayer);
      } else {
        const newPlayer = await prisma.player.create({ data: player });
        console.log(
          `✅ Created player: ${player.first_name} ${player.last_name}`,
        );
        createdPlayers.push(newPlayer);
      }
    } catch (error) {
      console.log(
        `⚠️  Could not create player ${player.first_name} ${player.last_name}:`,
        error,
      );
    }
  }
  ...
  for (const player of createdPlayers) {
    ...
    for (const game of selectedGames) {
      try {
        ...
        await prisma.playerGameProfile.create({ data: gameProfile });
        console.log(
          `✅ Created ${game.short_name} profile for ${player.first_name} ${player.last_name}`,
        );
      } catch (error) {
        console.log(
          `⚠️  Could not create ${game.short_name} profile for ${player.first_name} ${player.last_name}:`,
          error,
        );
      }
    }
    ...
    for (const platform of selectedPlatforms) {
      try {
        const existingConnection =
          await prisma.playerPlatformConnection.findUnique({
            where: {
              player_id_platform: {
                player_id: player.id,
  ...
  for (const player of createdPlayers) {
    ...
    const selectedSocials = getRandomElements(
      socialPlatformsPool,
      numConnections,
    );
    ...
    for (const social of selectedSocials) {
      try {
        const existingConnection =
          await prisma.playerSocialConnection.findUnique({
            where: {
              player_id_platform: {
                player_id: player.id,
        ...
        if (social === "Discord") {
          username = `${player.username ?? player.first_name.toLowerCase() + player.last_name.toLowerCase()}#${Math.floor(
            Math.random() * 9999,
          )
            .toString()
            .padStart(4, "0")}`;
  ...
  for (const combine of createdCombines) {
    ...
    const baseRegistrations = Math.min(
      combine.max_spots,
      Math.floor(combine.max_spots * 0.7),
    ); // 70% of max spots
    const additionalRegistrations = Math.floor(
      Math.random() * Math.min(10, combine.max_spots - baseRegistrations),
    ); // Random additional
    const totalRegistrations = baseRegistrations + additionalRegistrations;

    // Select random players for this combine
    const selectedPlayers = getRandomElements(
      allPlayersForRegistration,
      Math.min(totalRegistrations, allPlayersForRegistration.length),
    );
    ...
    for (const player of selectedPlayers) {
      try {
        ...
        const existingRegistration =
          await prisma.combineRegistration.findUnique({
            where: {
        ...
        await prisma.combineRegistration.create({
          data: {
            ...
            registered_at: new Date(
              combine.date.getTime() -
                Math.floor(Math.random() * 30) * 24 * 60 * 60 * 1000, // 0-30 days before combine
            ),
          },
        });

        console.log(
          `✅ Created ${status} registration for ${player.first_name} ${player.last_name} → ${combine.title}`,
        );
      } catch (error) {
        console.log(
          `⚠️  Could not create registration for ${player.first_name} ${player.last_name} → ${combine.title}:`,
          error,
        );
      }
    }
    ...
    console.log(
      `📊 Updated ${combine.title}: ${confirmedRegistrations}/${combine.max_spots} confirmed spots`,
    );
  }
  ...
  const testLeague = {
    ...
    short_name: "ECCEL",
    description:
      "A competitive collegiate esports league featuring top schools from the East Coast",
    region: "Northeast",
    state: "Multi-State",
    tier: "ELITE" as const,
    season: "Spring 2024",
  ...
  if (
    ...
    for (let i = 0; i < selectedSchools.length; i++) {
      ...
      try {
        ...
        if (existingTeam) {
          ...
          const teamCoach = createdCoaches.find(
          ...
          for (const player of selectedPlayers) {
            try {
              ...
              if (!existingMembership) {
                ...
                const existingPlayerLeague =
                  await prisma.playerLeague.findUnique({
                    where: {
                ...
                if (!existingPlayerLeague) {
                  ...
                  await prisma.playerLeague.update({
                    ...
                    data: {
                      games_played: {
                        increment: Math.floor(Math.random() * 15) + 7,
                      }, // 7-21 games
                    },
                  });
                }
                ...
                console.log(
                  `✅ Added ${player.first_name} ${player.last_name} to ${teamName}`,
                );
              }
            } catch (error) {
    ...
    console.log(
      `🏆 Test league setup complete with ${createdTeams.length} teams`,
    );
  } else {
  ...
  allPlayers.forEach((player) => {
    console.log(
      `   • ${player.first_name} ${player.last_name} (${player.main_game?.short_name ?? "No main game"}) - ${player.school_ref?.name ?? player.school ?? "No school"}`,
    );
  });
  ...
  allTryouts.forEach((tryout) => {
    console.log(
      `   • ${tryout.title} - ${tryout.game.name} at ${tryout.school.name}`,
    );
  });
  ...
  allLeagues.forEach((league) => {
    console.log(
      `   • ${league.name} (${league.season}) - ${league.teams.length} teams from ${league.schools.length} schools`,
    );
  });
  ...
  allTeams.forEach((team) => {
    console.log(
      `   • ${team.name} - ${team.game.name} at ${team.school.name} (${team.members.length} players)`,
    );
  });
}
