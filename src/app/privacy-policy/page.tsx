      ...
      <div className="container mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="font-rajdhani rounded-xl bg-gray-800/50 p-8 leading-relaxed text-gray-300 md:p-12">
          <p className="mb-6">
            ...
            &ldquo;Services&rdquo;), and our practices for collecting, using,
          ...
          <p className="mb-8">
            ...
            EVAL Gaming Inc. (&ldquo;EVAL Gaming Inc.&rdquo;, &ldquo;we&rdquo;,
            &ldquo;us&rdquo; or &ldquo;our&rdquo;). If you are entering into
            ...
            Policy, in which case the terms &ldquo;User&rdquo;,
            &ldquo;you&rdquo; or &ldquo;your&rdquo; shall refer to such entity.
            If you do not have such authority, or if you do not agree with the
            terms of this Policy, you must not accept this Policy and may not
          ...
          <div className="mb-8 rounded-lg bg-gray-700/50 p-6">
            ...
            <ol className="space-y-2 text-sm">
              <li>
                <a
                  href="#automatic-collection-of-information"
                  className="text-cyan-400 transition-colors hover:text-cyan-300"
                >
          ...
          <section id="automatic-collection-of-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              the Website and Services, pages of the Website and Services that
              you visit, the time spent on those pages, information you search
          ...
          <section id="collection-of-personal-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              you wish to use some of the features offered on the Website, you
            ...
            <p className="mb-4">
              ...
              may include demographic information, such as age and gender,
              device information, such as IP addresses, location, such as city
              and state, and online behavioral data, such as information about
          ...
          >
            ...
            <p className="mb-4">
              ...
              User providing Personal Information acts as a data controller.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              and if one of the following applies: (a) you have given your
              consent for one or more specific purposes; (b) provision of
              information is necessary for the performance of this Policy with
              you and/or for any pre-contractual obligations thereof; (c)
              processing is necessary for compliance with a legal obligation to
              which you are subject; (d) processing is related to a task that is
              carried out in the public interest or in the exercise of official
              authority vested in us; (e) processing is necessary for the
              purposes of the legitimate interests pursued by us or by a third
              party. We may also combine or aggregate some of your Personal
              Information in order to better serve you and to improve and update
              our Website and Services.
            </p>
            <p className="mb-4">
              By providing your phone number, you consent to receive SMS
              messages from us related to your use of the Website and Services.
              We only send SMS messages to users who have voluntarily provided
              their phone number and have consented to such communications.
              Message frequency may vary depending on your activity and
              interactions with us. Standard message and data rates may apply
              based on your mobile carrier and service plan. We are not
              responsible for any charges billed to you by your mobile carrier.
              You can opt out of receiving SMS messages at any time by following
              the instructions provided in the message (e.g., replying
              &quot;STOP&quot;) or by contacting us directly.
            </p>
            <p className="mb-4">
          ...
          <section id="payment-processing" className="mb-8">
            ...
            <p className="mb-4">
              ...
              third-party payment processors (&quot;Payment Processors&quot;) to
            ...
            <p className="mb-4">
              ...
              compliance with strict vulnerability standards in order to create
          ...
          <section id="managing-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              do so on the settings page of your account on the Website or
          ...
          <section id="disclosure-of-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              share your non-personally identifiable information with our
              trusted subsidiaries and joint venture partners, contracted
              ...
              with respect to your information. We will not share any
          ...
          <section id="retention-of-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              Policy, resolve disputes, and unless a longer retention period is
          ...
          <section id="transfer-of-information" className="mb-8">
            ...
            <p className="mb-4">
              We do not transfer or store your Personal Information outside your
              country of residence. All Personal Information collected is
              processed and maintained within your jurisdiction, in compliance
              with applicable data protection laws. In cases where local
              regulations require specific security measures for data storage
              and processing, we ensure full compliance by implementing
              appropriate technical and organizational safeguards.
            </p>
            <p className="mb-4">
              If any changes to our data storage practices occur, we will update
              this policy accordingly and notify you as required by law. Note
              that we are dedicated to ensuring the security of your personal
          ...
          <section id="region-specific-notices" className="mb-8">
            ...
            <p className="mb-4">
              ...
              measures to comply with the obligations and rights associated with
              the collection of Personal Information as dictated by the laws
              governing the regions of our users.
            </p>

            <h3 className="font-orbitron mb-3 text-xl text-white">
              Disclosures for residents of the USA
            </h3>
            <p className="mb-4">
              If you are a resident of California, Colorado, Connecticut,
              Delaware, Iowa, Maryland, Utah, or Virginia, you have certain
              rights and we aim to take reasonable steps to allow you to
              correct, amend, delete, or limit the use of your Personal
              Information. This supplemental section, together with other
              relevant sections of the Policy, provides information about your
              rights and how to exercise them under the California Consumer
              Privacy Act and the California Privacy Rights Act (collectively, &
            </p>
            <p className="mb-4">
              As described in this Policy in the information collection section
              above, we have collected the categories of Personal Information
            ...
            <p className="mb-4">
              As described in this Policy in the disclosure section above, we
              have disclosed the categories of Personal Information listed below
            ...
            <p className="mb-4">
              In addition to the rights as explained in this Policy, if you
              provide Personal Information as defined in the statute to obtain
              Services for personal, family, or household use, you have the
              right to submit requests related to your Personal Information once
              a calendar year. Note that there are circumstances when we may not
              be able to comply with your request such as when we are not able
              to verify your request or find that providing a full response
              conflicts with other legal obligations or regulatory requirements.
              You will be notified if it&apos;s the case.
            </p>
            <p className="mb-4">
              (a) Right to know and right to access: You have the right to
              request certain information we have collected about you. Once we
              receive and confirm a verifiable request from you, we will
              disclose to you, to the extent permitted by law:
            </p>
            <ul className="mb-4 list-inside list-disc space-y-2">
              <li>
              ...
              <li>
                The purposes the categories of Personal Information are
                collected or used for.
              </li>
              <li>
              ...
              <li>
                The purposes for collecting, selling, or sharing your Personal
                Information.
              </li>
              <li>
                Whether or not your Personal Information is sold or shared with
                third parties.
              </li>
            </ul>
            <p className="mb-4">
              You have the right to request that the Personal Information is
              delivered in a format that is both portable and easily usable, as
              long as it is technically possible to do so.
            </p>
            <p className="mb-4">
              (b) Right to correct: You have the right to request that we
              correct your inaccurate Personal Information taking into account
              the nature of the Personal Information and the purposes of the
              processing of the Personal Information.
            </p>
            <p className="mb-4">
              (c) Right to delete: You have the right to request deletion of
              your Personal Information.
            </p>
            <p className="mb-4">
              (d) Right to opt-out of the sale and sharing: You have the right
              to opt-out of the sale of your Personal Information which may
              include selling, disclosing, or transferring Personal Information
              to another business or a third party for monetary or other
              valuable consideration.
            </p>
            <p className="mb-4">
              (e) Right to consent to or limit the use of your sensitive
              personal information: You have the right to consent to the use of
              your Sensitive Personal information and to direct us to restrict
              its use and disclosure solely to what is essential for carrying
              out or delivering the Services in a manner reasonably anticipated
              by an average user, or for certain business objectives as
              specified by law. However, we do not use Sensitive Personal
              Information for any purposes other than those legally permitted or
              beyond the scope of your consent.
            </p>
            <p className="mb-4">
              ...
              receive from us for exercising your rights. We may not, and will
              not, treat you differently because of your data subject request
              activity, and we may not and will not deny goods or Services to
            ...
            <p className="mb-4">
              ...
              personal information is disclosed to third parties for their
              direct marketing purposes under California&apos;s &quot;Shine the
              Light&quot; law, or the right to opt out of such practices.
            </p>
            <p className="mb-4">
              To exercise any of your rights, simply contact us using the
              details below. After we receive and verify your request, we will
              process it to the extent possible within our capabilities.
            </p>
            ...
            <p className="mb-4">
              If you reside in a country not specifically mentioned in this
              policy, we are committed to protecting your personal data in
              accordance with internationally recognized privacy principles.
              Users from these regions may have rights similar to those outlined
              above and other data protection laws. These rights include:
            </p>
            <ul className="mb-4 list-inside list-disc space-y-2">
              <li>
              ...
              <li>
                The right to opt out of targeted advertising and data sales,
                where required by law.
              </li>
              <li>
                The right to file a grievance with a relevant data protection
                authority.
              </li>
              <li>
                The right to nominate a representative to exercise your privacy
                rights on your behalf, if permitted by applicable regulations.
              </li>
            </ul>
          </section>
          ...
          <section id="cookies" className="mb-8">
            <h2 className="font-orbitron mb-4 text-2xl text-white">Cookies</h2>
            <p className="mb-4">
              Our Website and Services use &quot;cookies&quot; to help
              ...
              web server in the domain that issued the cookie to you. If you
              choose to decline cookies, you may not be able to fully experience
              the features of the Website and Services.
            </p>
            <p className="mb-4">
              ...
              and for statistical purposes. Please note that you have the
              ability to accept or decline cookies. Most web browsers
              automatically accept cookies by default, but you can modify your
          ...
          <section id="data-analytics" className="mb-8">
            ...
            <p className="mb-4">
              ...
              monitor the performance and improve our Website and Services.
            </p>
          </section>
          ...
          <section id="do-not-sell-my-personal-information" className="mb-8">
            ...
            <p className="mb-4">
              ...
              sold or disclosed by contacting us. Upon receiving and verifying
              your request, we will cease the sale and disclosure of your
              Personal Information. Be aware, however, that opting out of data
              transfers to our third parties might affect our ability to provide
              certain Services you have signed up for. We reserve the right to
              reject opt-out requests in certain situations as permitted by the
              CCPA, such as when the sale of Personal Information is required
              for us to fulfill legal or contractual duties.
            </p>
          </section>
          ...
          <section id="do-not-track-signals" className="mb-8">
            ...
            <p className="mb-4">
              ...
              from users who use or visit a website or online service as they
              move across different websites over time. How browsers communicate
              the Do Not Track signal is not yet uniform. As a result, the
              Website and Services are not yet set up to interpret or respond to
              ...
              and collection of your Personal Information. For a description of
              Do Not Track protocols for browsers and mobile devices or to learn
          ...
          <section id="social-media-features" className="mb-8">
            ...
            <p className="mb-4">
              ...
              visiting on our Website and Services, and may set a cookie to
              enable Social Media Features to function properly. Social Media
          ...
          <section id="email-marketing" className="mb-8">
            ...
            <p className="mb-4">
              ...
              subscribe at any time. We are committed to keeping your email
              ...
              sent via email in accordance with applicable laws and regulations.
            </p>
            <p className="mb-4">
              In compliance with the CAN-SPAM Act, all emails sent from us will
              clearly state who the email is from and provide clear information
          ...
          <section id="push-notifications" className="mb-8">
            ...
            <p className="mb-4">
              ...
              the information sent via email in accordance with applicable laws
          ...
          <section id="information-security" className="mb-8">
            ...
            <p className="mb-4">
              ...
              you acknowledge that (a) there are security and privacy
              ...
              guaranteed; and (c) any such information and data may be viewed or
          ...
          <section id="data-breach" className="mb-8">
            ...
            <p className="mb-4">
              ...
              Services has been compromised or Users&apos; Personal Information
            ...
            <p className="mb-4">
              ...
              if notice is otherwise required by law. When we do, we will send
              you an email. In jurisdictions where required, we may also report
              the breach to relevant authorities in accordance with applicable
          ...
          <section id="contacting-us" className="mb-8">
            ...
            <p className="mb-4">
              <a
                href="https://app.websitepolicies.com/dsar/view/tdnd5urj"
                className="text-cyan-400 transition-colors hover:text-cyan-300"
              >
            ...
            <p className="mb-4">
              ...
              you may escalate the matter to the appropriate data protection
              authority in your region, in accordance with applicable privacy
              laws.
            </p>
