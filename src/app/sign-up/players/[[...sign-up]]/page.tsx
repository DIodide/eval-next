        ...
        <div className="hidden flex-col justify-center px-12 lg:flex lg:w-1/2 xl:px-16">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg leading-relaxed font-medium text-gray-300">
              Join the premier esports platform and showcase your skills to
              coaches, teams, and the competitive gaming community.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Professional player profile with stats, highlights, and
                  achievements
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Connect with college coaches and competitive teams actively
                  scouting talent
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Participate in tryouts, combines, and tournaments to prove
                  your worth
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Advanced analytics and performance tracking across multiple
                  games
                </p>
              </div>
            </div>
