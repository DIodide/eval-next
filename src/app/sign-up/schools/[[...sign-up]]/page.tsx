        ...
        <div className="hidden flex-col justify-center px-12 lg:flex lg:w-1/2 xl:px-16">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg leading-relaxed font-medium text-gray-300">
              Join the premier esports platform and discover talented players
              for your competitive gaming programs.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Advanced search tools to find players with the skills and
                  potential you need
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Connect directly with players and build relationships with
                  prospects
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Associate with your institution and represent your esports
                  program
                </p>
              </div>
            </div>
