      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            right: '0',
            bottom: '0',
            background: 'radial-gradient(circle at 20% 30%, rgba(245, 158, 11, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(239, 68, 68, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(168, 85, 247, 0.1) 0%, transparent 50%)',
            display: 'flex',
          }} />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ display: 'flex', marginBottom: '10px' }}>COMBINE</span>
                <span style={{ 
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #f59e0b 0%, #ef4444 33%, #a855f7 66%, #06b6d4 100%)',
            display: 'flex',
          }} />
        </div>
      ),
