...
export async function GET(request: Request) {
  try {
    ...
    console.log("Generating static school sign-up OpenGraph image");
        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(249, 115, 22, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(234, 88, 12, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(194, 65, 12, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(90deg, rgba(249, 115, 22, 0.2), rgba(234, 88, 12, 0.2))",
          ...
          >
            ...
            >
              Build your esports program and recruit talent
            </div>
          </div>
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #f97316 0%, #ea580c 33%, #c2410c 66%, #9a3412 100%)",
              display: "flex",
            }}
          />
        </div>
    ...
    console.error("Error generating school sign-up OpenGraph image:", error);
