      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            right: 0,
            bottom: 0,
            background: 'radial-gradient(circle at 30% 30%, rgba(6, 182, 212, 0.15) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(139, 92, 246, 0.15) 0%, transparent 50%), radial-gradient(circle at 50% 90%, rgba(245, 158, 11, 0.1) 0%, transparent 50%)',
            display: 'flex',
          }} />
