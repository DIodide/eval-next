...
export async function GET(
  ...
  try {
    ...
    const schoolBio =
      school.bio ??
      `${schoolName} is a ${schoolType.toLowerCase()} esports program committed to competitive excellence and player development.`;
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              {schoolBio.length > 200
                ? `${schoolBio.substring(0, 200)}...`
                : schoolBio}
            </div>
          </div>
