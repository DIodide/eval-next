        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(245, 158, 11, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(217, 119, 6, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(180, 83, 9, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #f59e0b 0%, #d97706 33%, #b45309 66%, #92400e 100%)",
              display: "flex",
            }}
          />
        </div>
