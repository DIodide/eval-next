        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(6, 182, 212, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(8, 145, 178, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(14, 116, 144, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(90deg, rgba(6, 182, 212, 0.2), rgba(8, 145, 178, 0.2))",
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #06b6d4 0%, #0891b2 33%, #0e7490 66%, #155e75 100%)",
              display: "flex",
            }}
          />
        </div>
