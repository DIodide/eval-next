        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(34, 197, 94, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(21, 128, 61, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(22, 101, 52, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(90deg, #22c55e 0%, #15803d 50%, #166534 100%)",
                    backgroundClip: "text",
                    color: "transparent",
                    display: "flex",
                  }}
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #22c55e 0%, #15803d 33%, #166534 66%, #14532d 100%)",
              display: "flex",
            }}
          />
        </div>
