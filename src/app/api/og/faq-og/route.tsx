        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 25% 25%, rgba(6, 182, 212, 0.1) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(139, 92, 246, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(90deg, rgba(6, 182, 212, 0.2), rgba(139, 92, 246, 0.2))",
          ...
          >
            ...
            >
              Find answers to common questions about EVAL and our esports
              recruiting platform
            </div>
