        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(147, 51, 234, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(126, 34, 206, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(109, 40, 217, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(90deg, rgba(147, 51, 234, 0.2), rgba(126, 34, 206, 0.2))",
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(90deg, #9333ea 0%, #7e22ce 50%, #6d28d9 100%)",
                    backgroundClip: "text",
                    color: "transparent",
                    display: "flex",
                  }}
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #9333ea 0%, #7e22ce 33%, #6d28d9 66%, #5b21b6 100%)",
              display: "flex",
            }}
          />
        </div>
