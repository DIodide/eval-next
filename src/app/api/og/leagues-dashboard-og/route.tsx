        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "0",
              background:
                "radial-gradient(circle at 20% 30%, rgba(99, 102, 241, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(139, 92, 246, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(6, 182, 212, 0.1) 0%, transparent 50%)",
              display: "flex",
            }}
          />
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #6366f1 0%, #8b5cf6 33%, #06b6d4 66%, #ef4444 100%)",
              display: "flex",
            }}
          />
        </div>
