        ...
        >
          ...
          <div
            style={{
              ...
              bottom: 0,
              background:
                "linear-gradient(135deg, rgba(6, 182, 212, 0.15) 0%, rgba(147, 51, 234, 0.15) 30%, rgba(245, 101, 101, 0.15) 60%, rgba(251, 146, 60, 0.15) 100%)",
              display: "flex",
            }}
          />
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "50px",
                  background:
                    "linear-gradient(180deg, rgba(147, 51, 234, 0.5) 0%, rgba(6, 182, 212, 0.5) 100%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "50px",
                  background:
                    "linear-gradient(180deg, rgba(6, 182, 212, 0.5) 0%, rgba(251, 146, 60, 0.5) 100%)",
                  display: "flex",
                }}
              />
          ...
          <div
            style={{
              ...
              height: "8px",
              background:
                "linear-gradient(90deg, #06b6d4 0%, #8b5cf6 25%, #f59e0b 50%, #ef4444 75%, #8b5cf6 100%)",
              display: "flex",
            }}
          />
        </div>
