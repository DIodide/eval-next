...
export async function GET(request: Request) {
  try {
    ...
    console.log("Generating static coaches dashboard OpenGraph image");
      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            {/* Coaches Dashboard Badge */}
            <div style={{
              background: 'linear-gradient(90deg, rgba(245, 158, 11, 0.2), rgba(139, 92, 246, 0.2))',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ display: 'flex', marginBottom: '10px' }}>COACHES</span>
                <span style={{ 
            ...
            <div style={{ 
              ...
              Recruit talent and build your team
            </div>
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #f59e0b 0%, #8b5cf6 33%, #06b6d4 66%, #ef4444 100%)',
            display: 'flex',
          }} />
        </div>
      ),
    ...
    console.error('Error generating coaches dashboard OpenGraph image:', error);
