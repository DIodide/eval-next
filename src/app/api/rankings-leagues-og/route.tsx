      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            right: '0',
            bottom: '0',
            background: 'radial-gradient(circle at 20% 30%, rgba(99, 102, 241, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(245, 158, 11, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(34, 197, 94, 0.1) 0%, transparent 50%)',
            display: 'flex',
          }} />
          ...
          <div style={{
            ...
            <div style={{
              background: 'linear-gradient(90deg, rgba(99, 102, 241, 0.2), rgba(245, 158, 11, 0.2))',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ 
                  background: 'linear-gradient(90deg, #6366f1 0%, #f59e0b 50%, #22c55e 100%)',
                  backgroundClip: 'text',
                  color: 'transparent',
                  display: 'flex',
                }}>
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #6366f1 0%, #f59e0b 33%, #22c55e 66%, #06b6d4 100%)',
            display: 'flex',
          }} />
        </div>
      ),
