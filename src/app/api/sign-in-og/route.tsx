      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            right: '0',
            bottom: '0',
            background: 'radial-gradient(circle at 20% 30%, rgba(6, 182, 212, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(147, 51, 234, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(249, 115, 22, 0.1) 0%, transparent 50%)',
            display: 'flex',
          }} />
          ...
          <div style={{
            ...
            {/* Welcome Back Badge */}
            <div style={{
              background: 'linear-gradient(90deg, rgba(100, 116, 139, 0.2), rgba(148, 163, 184, 0.2))',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ display: 'flex', marginBottom: '10px' }}>SIGN INTO</span>
                <span style={{ 
                  background: 'linear-gradient(90deg, #06b6d4 0%, #9333ea 50%, #f97316 100%)',
                  backgroundClip: 'text',
                  color: 'transparent',
                  display: 'flex',
                }}>
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #06b6d4 0%, #9333ea 33%, #f97316 66%, #ef4444 100%)',
            display: 'flex',
          }} />
        </div>
      ),
