...
export async function GET(request: Request) {
  try {
    ...
    console.log("Generating static dashboard OpenGraph image");
      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ display: 'flex', marginBottom: '10px' }}>YOUR</span>
                <span style={{ 
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #8b5cf6 0%, #06b6d4 33%, #f59e0b 66%, #ef4444 100%)',
            display: 'flex',
          }} />
        </div>
      ),
    ...
    console.error('Error generating dashboard OpenGraph image:', error);
