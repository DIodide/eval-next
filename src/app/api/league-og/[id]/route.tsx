...
export async function GET(
  ...
  try {
    ...
    const leagueDescription = league.description ?? `${leagueName} is a ${leagueTier.toLowerCase()} tier esports league operating in ${leagueRegion}. Join competitive gaming teams and participate in organized tournaments.`;
    ...
    const totalSchools = Array.isArray(league.schools) ? league.schools.length : 0;
    ...
    const supportedGames = Array.isArray(league.league_games) ? league.league_games.length : 0;
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              {leagueDescription.length > 200 ? `${leagueDescription.substring(0, 200)}...` : leagueDescription}
            </div>
          </div>
