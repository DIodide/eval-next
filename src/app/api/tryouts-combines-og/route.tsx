      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            right: '0',
            bottom: '0',
            background: 'radial-gradient(circle at 20% 30%, rgba(239, 68, 68, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(168, 85, 247, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(6, 182, 212, 0.1) 0%, transparent 50%)',
            display: 'flex',
          }} />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 style={{ 
                ...
                <span style={{ display: 'flex', marginBottom: '10px' }}>TRYOUT</span>
                <span style={{ 
          ...
          <div style={{
            ...
            right: '0',
            height: '8px',
            background: 'linear-gradient(90deg, #ef4444 0%, #a855f7 33%, #06b6d4 66%, #f59e0b 100%)',
            display: 'flex',
          }} />
        </div>
      ),
