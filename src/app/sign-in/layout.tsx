...
export const metadata: Metadata = {
  ...
  description:
    "Access your esports platform and continue your journey. Sign in to your EVAL Gaming account to manage your profile, track stats, and connect with the esports community.",
  keywords: [
    "sign in",
    "login",
