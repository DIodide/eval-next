    ...
    <div className="min-h-screen bg-gradient-to-b from-black/60 to-black/80">
      <div className="container mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="font-rajdhani rounded-xl bg-gray-800/50 p-8 leading-relaxed text-gray-300 md:p-12">
          <p className="mb-8">
            This cookie policy (&ldquo;Policy&rdquo;) describes what cookies are
            and how they&apos;re being used by the{" "}
            <a
            ...
            &ldquo;Services&rdquo;). This Policy is a legally binding agreement
            between you (&ldquo;User&rdquo;, &ldquo;you&rdquo; or
            &ldquo;your&rdquo;) and EVAL Gaming Inc. (&ldquo;EVAL Gaming
            Inc.&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
            &ldquo;our&rdquo;). If you are entering into this Policy on behalf
            of a business or other legal entity, you represent that you have the
            authority to bind such entity to this Policy, in which case the
            terms &ldquo;User&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo;
            shall refer to such entity. If you do not have such authority, or if
            you do not agree with the terms of this Policy, you must not accept
            this Policy and may not access and use the Website and Services. You
            should read this Policy so you can understand the types of cookies
            ...
            see our{" "}
            <a
              href="https://www.evalgaming.com/privacy-policy"
              className="text-cyan-400 transition-colors hover:text-cyan-300"
            >
              privacy policy
            </a>
          ...
          <div className="mb-8 rounded-lg bg-gray-700/50 p-6">
            ...
            <ol className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="#do-we-use-web-beacons-or-tracking-pixels"
                  className="text-cyan-400 transition-colors hover:text-cyan-300"
                >
              ...
              <li>
                <a
                  href="#what-are-your-cookie-options"
                  className="text-cyan-400 transition-colors hover:text-cyan-300"
                >
          ...
          <section id="what-are-cookies" className="mb-8">
            ...
            <p className="mb-4">
              ...
              preferences, either for a single visit (through a &ldquo;session
              cookie&rdquo;) or for multiple repeat visits (using a
              &ldquo;persistent cookie&rdquo;).
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Cookies may be set by the Website (&ldquo;first-party
              cookies&rdquo;), or by third parties, such as those who serve
              content or provide advertising or analytics services on the
              Website (&ldquo;third party cookies&rdquo;). These third parties
              can recognize you when you visit our website and also when you
          ...
          {/* Section 3 */}
          <section
            id="do-we-use-web-beacons-or-tracking-pixels"
            className="mb-8"
          >
            <h2 className="font-orbitron mb-4 text-2xl text-white">
            ...
            <p className="mb-4">
              Our emails may contain a &ldquo;web beacon&rdquo; (or
              &ldquo;tracking pixel&rdquo;) to tell us whether our emails are
              opened and verify any clicks through to links or advertisements
              within the email.
            </p>
            <p className="mb-4">
          ...
          <section id="contacting-us" className="mb-8">
            ...
            <div className="mb-4 rounded-lg bg-gray-700/50 p-4">
              ...
              <p>
                <a
                  href="mailto:info@evalgaming.com"
                  className="text-cyan-400 transition-colors hover:text-cyan-300"
                >
                  info@evalgaming.com
                </a>
              ...
              <p>
                <a
                  href="https://www.evalgaming.com/contact"
                  className="text-cyan-400 transition-colors hover:text-cyan-300"
                >
