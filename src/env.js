...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    DISCORD_WEBHOOK_SCHOOL_ASSOCIATION:
      process.env.DISCORD_WEBHOOK_SCHOOL_ASSOCIATION,
    DISCORD_WEBHOOK_REGISTRATIONS: process.env.DISCORD_WEBHOOK_REGISTRATIONS,
    NEXT_PUBLIC_DISCORD_WEBHOOK_CONTACT:
      process.env.NEXT_PUBLIC_DISCORD_WEBHOOK_CONTACT,
