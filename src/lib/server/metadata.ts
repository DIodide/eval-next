...
export function generatePlayerMetadata(
  ...
  if (player.mainGame)
    descriptionParts.push(`specializing in ${player.mainGame}`);
...
export function generateEventMetadata(event: EventMetadataOptions): Metadata {
  ...
  descriptionParts.push(
    `Register now for this competitive esports ${event.type}.`,
  );
...
export const staticPageMetadata = {
  home: generateMetadata({
    ...
    description:
      "The premier platform connecting student gamers with college esports programs and scholarships. Get ranked, get recruited, get scholarships.",
    keywords: [
      "college esports",
      "esports scholarships",
      "gaming recruitment",
  ...
  recruiting: generateMetadata({
    ...
    description:
      "The bridge between talent and opportunity. Connecting esports players with college programs through advanced analytics and recruitment tools. Access $50M+ in scholarships.",
    keywords: [
      "esports recruiting",
      "college esports",
      "esports scholarships",
  ...
  dashboard: generateMetadata({
    ...
    description:
      "Your command center for esports success. Access analytics, insights, and control everything from your personalized dashboard.",
    keywords: [
      "esports dashboard",
      "gaming analytics",
  ...
  playerDashboard: generateMetadata({
    ...
    description:
      "Track your gaming journey and achievements. Monitor your performance, stats, and progress toward your esports goals.",
    keywords: [
      "player dashboard",
      "gaming progress",
      "esports tracking",
  ...
  coachesDashboard: generateMetadata({
    ...
    description:
      "Recruit talent and build your team. Access powerful coaching tools to discover players, manage prospects, and coordinate tryouts.",
    keywords: [
      "coaches dashboard",
      "esports recruiting",
      "coaching tools",
  ...
  leaguesDashboard: generateMetadata({
    ...
    description:
      "Manage teams and competitive seasons. Access powerful league administration tools to organize tournaments, track rankings, and coordinate esports competitions.",
    keywords: [
      "league dashboard",
  ...
  tryoutsCombines: generateMetadata({
    ...
    description:
      "Showcase your skills in competitive esports events. Join tryout combines to demonstrate your abilities and get noticed by coaches and scouts.",
    keywords: [
      "tryout combines",
      "esports tryouts",
      "competitive events",
  ...
  tryoutsCollege: generateMetadata({
    ...
    description:
      "Join collegiate esports teams and programs. Find opportunities to compete at the college level and pursue esports scholarships.",
    keywords: [
      "college tryouts",
      "collegiate esports",
      "esports scholarships",
  ...
  rankingsCombines: generateMetadata({
    ...
    description:
      "See where you rank among the competition. Track your performance in combines and compare your skills against other players.",
    keywords: [
      "combine rankings",
      "player rankings",
  ...
  rankingsLeagues: generateMetadata({
    ...
    description:
      "Track team standings and league competition. Follow league rankings, tournament brackets, and competitive seasons across multiple games.",
    keywords: [
      "league rankings",
      "team standings",
      "tournament brackets",
  ...
  pricing: generateMetadata({
    ...
    description:
      "Choose the perfect plan for your esports journey. Affordable pricing for players and comprehensive solutions for coaches and schools.",
    keywords: [
      "esports platform pricing",
      "college esports cost",
      "gaming platform subscription",
      "esports recruiting pricing",
      "EVAL",
      "EVAL Gaming",
    ],
  ...
  aboutTeam: generateMetadata({
    ...
    description:
      "Meet the passionate team behind EVAL, dedicated to transforming college esports and creating opportunities for student gamers.",
    keywords: [
      "EVAL team",
      "esports leadership",
      "gaming industry professionals",
      "college esports experts",
      "EVAL",
      "EVAL Gaming",
    ],
  ...
  aboutContact: generateMetadata({
    ...
    description:
      "Contact the EVAL team for support, partnerships, or questions about our college esports recruiting platform.",
    keywords: [
      "contact EVAL",
      "esports support",
      "platform help",
      "gaming platform contact",
      "EVAL",
      "EVAL Gaming",
    ],
  ...
  aboutFaq: generateMetadata({
    ...
    description:
      "Find answers to common questions about EVAL, college esports recruiting, scholarships, and our platform features.",
    keywords: [
      "EVAL FAQ",
      "esports questions",
      "college gaming help",
      "platform support",
      "esports recruiting FAQ",
      "EVAL",
      "EVAL Gaming",
    ],
  ...
  aboutPartners: generateMetadata({
    ...
    description:
      "Discover our trusted partners and collaborations that help make college esports opportunities accessible to all student gamers.",
    keywords: [
      "EVAL partners",
      "esports partnerships",
      "college gaming collaborations",
  ...
  rankings: generateMetadata({
    ...
    description:
      "View comprehensive esports rankings for players, teams, and schools. Track performance across games and compete for top positions.",
    keywords: [
      "esports rankings",
      "gaming leaderboards",
      "player rankings",
      "team standings",
      "college esports stats",
      "EVAL",
      "EVAL Gaming",
    ],
  }),
  ...
  privacyPolicy: generateMetadata({
    ...
    description:
      "How we protect and handle your data. Read our privacy policy to understand how EVAL protects and uses your personal information on our esports recruiting platform.",
    keywords: [
      "privacy policy",
      "data protection",
      "user privacy",
  ...
  termsOfService: generateMetadata({
    ...
    description:
      "Platform terms and user agreements. Review the terms of service for using the EVAL esports recruiting platform and our services.",
    keywords: [
      "terms of service",
      "platform terms",
      "user agreement",
  ...
  cookiePolicy: generateMetadata({
    ...
    description:
      "How we use cookies to enhance your experience. Learn about how EVAL uses cookies to improve your experience on our esports recruiting platform.",
    keywords: [
      "cookie policy",
      "website cookies",
      "data tracking",
  ...
  news: generateMetadata({
    ...
    description:
      "Stay updated with the latest insights, platform updates, and industry news from the EVAL team. Get the latest in college esports and gaming recruitment.",
    keywords: [
      "EVAL news",
      "esports news",
      "platform updates",
