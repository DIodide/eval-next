...
interface FileUploadProps {
  ...
  customRecommendedSize?: { width: number; height: number; description: string }
...
export function FileUpload({
  ...
  const recommendedSize = customRecommendedSize ?? UPLOAD_CONSTRAINTS.RECOMMENDED_SIZES[assetType]
  ...
  }, [bucket, entityId, assetType, currentImageUrl, disabled, onUploadSuccess, onUploadError])
        ...
        {!previewUrl && (
          <Card
            className={cn(
              ...
              dragOver ? 'border-blue-400 bg-blue-50/10' : 'border-gray-600 hover:border-gray-500',
            ...
            <CardContent className="flex flex-col items-center justify-center p-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  PNG, JPG, JPEG, WebP up to {UPLOAD_CONSTRAINTS.MAX_FILE_SIZE / 1024 / 1024}MB
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-start gap-4">
                <div className="relative">
                  <div className={cn(
                    ...
                    assetType === 'BANNER' ? 'w-48 h-12' : 'w-24 h-24'
                  )}>
                    <Image
                      src={previewUrl}
                      alt="Preview"
                ...
                <div className="flex-1 space-y-2">
                  {isUploading ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-300">Upload complete</span>
                    </div>
                  )}
